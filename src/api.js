...
io.on("connection", function(socket) {
  ...
  socket.on('onlineUsers', function(message) { // broadcast this message to all users in that room
    console.log("calling onlineUsers ..... ", message);
    // socket.broadcast.to(clientInfo[socket.id].room).emit("onlineUsers", message);
    socket.emit("onlineUsers", sendCurrentUsers(socket));
  });
